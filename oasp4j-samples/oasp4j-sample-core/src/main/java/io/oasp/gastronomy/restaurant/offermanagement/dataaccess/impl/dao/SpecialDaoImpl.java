...
public class SpecialDaoImpl extends ApplicationDaoImpl<SpecialEntity> implements SpecialDao {
  ...
  public PaginatedListTo<SpecialEntity> findSpecials(SpecialSearchCriteriaTo criteria) {
    ...
    WeeklyPeriodSearchCriteriaTo tmp = criteria.getActivePeriod();
    WeeklyPeriodEmbeddable activePeriod = new WeeklyPeriodEmbeddable();
    activePeriod.setEndingDay(tmp.getEndingDay());
    activePeriod.setEndingHour(tmp.getEndingHour());
    activePeriod.setStartingDay(tmp.getStartingDay());
    activePeriod.setStartingHour(tmp.getStartingHour());
